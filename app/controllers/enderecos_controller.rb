class EnderecosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @endereco.save
        format.html { redirect_to @endereco, notice: 'Endereco foi criado(a) com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @endereco.update(endereco_params)
        format.html { redirect_to @endereco, notice: 'Endereco foi atualizado(a) com sucesso.' }
  ...
  def destroy
    @endereco.destroy
    respond_to do |format|
      format.html { redirect_to enderecos_url, notice: 'Endereco foi excluído(a) com sucesso.' }
  ...
  private
    ...
    def endereco_params
      params.require(:endereco).permit(:endereco, :numero, :complemento, :cidade, :estado, :cep)
    end
end
