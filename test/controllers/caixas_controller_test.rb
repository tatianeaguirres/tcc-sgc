...
class CaixasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create caixa" do
    assert_difference('Caixa.count') do
      post caixas_url, params: { caixa: { data: @caixa.data, responsavel: @caixa.responsavel, status: @caixa.status } }
    end
  ...
  test "should update caixa" do
    patch caixa_url(@caixa), params: { caixa: { data: @caixa.data, responsavel: @caixa.responsavel, status: @caixa.status } }
