...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference('Orcamento.count') do
      post orcamentos_url, params: { orcamento: { cliente_id: @orcamento.cliente_id, emissao: @orcamento.emissao, validade: @orcamento.validade } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { cliente_id: @orcamento.cliente_id, emissao: @orcamento.emissao, validade: @orcamento.validade } }
