...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, fornecedor_id: @produto.fornecedor_id, nome: @produto.nome, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, fornecedor_id: @produto.fornecedor_id, nome: @produto.nome, preco: @produto.preco } }
