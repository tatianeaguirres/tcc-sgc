...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, preco_total: @venda.preco_total, status: @venda.status } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, data: @venda.data, preco_total: @venda.preco_total, status: @venda.status } }
